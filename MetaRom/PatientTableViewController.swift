...
//        }
        ...
        let cur = visiblePatients[indexPath.row]
        print(cur)
...
//        }
        ...
        performSegue(withIdentifier: "ShowPatient", sender: visiblePatients[indexPath.row])
    }
    ...
    func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == .delete {
            let alert = UIAlertController(title: "Confirm Delete", message: "Are you sure you want to delete \(visiblePatients[indexPath.row].fullName)?  This removes all of their data and cannot be undone.", preferredStyle: .actionSheet)
            alert.addAction(UIAlertAction(title: "Delete", style: .destructive, handler: { _ in
                let cur = self.visiblePatients.remove(at: indexPath.row)
