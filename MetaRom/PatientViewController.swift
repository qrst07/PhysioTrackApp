...
//screen showing max rom over time, with start button
...
//        doRefresh(showError: false)
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        nameLabel.text = "Shoulder Abductions"
...
////        } else
//        if let destination = segue.destination as? SingleSessionViewController {
